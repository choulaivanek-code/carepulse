...
public class TicketController {
    ...
    private TicketResponse mapToResponse(Ticket t) {
        ...
        return TicketResponse.builder()
                ...
                .patientNom((t.getPatient() != null && t.getPatient().getUser() != null) ? t.getPatient().getUser().getNom() : "")
                .patientPrenom((t.getPatient() != null && t.getPatient().getUser() != null) ? t.getPatient().getUser().getPrenom() : "")
                .fileAttenteId(t.getFileAttente() != null ? t.getFileAttente().getId() : null)
                .fileAttenteNom(t.getFileAttente() != null ? t.getFileAttente().getNom() : "")
                .scoreNoShow(t.getScoreNoShow())
                .medecinNom((t.getMedecin() != null && t.getMedecin().getUser() != null) ? t.getMedecin().getUser().getNom() + " " + t.getMedecin().getUser().getPrenom() : "Assignation en cours")
